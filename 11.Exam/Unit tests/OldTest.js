describe("Testing all the parameters and function of the object should return expected output", ()=>{
    ...
    describe("choosingType function should return correct outputs with correct input and expected errors with incorrect input",() => {
        ...
        it("if input year is a string an error is expected", () =>{
            //assign
            let expectedOutput = `Invalid Year!`;

            //act && assert
            assert.throw(() => chooseYourCar.choosingType("sedan","blue","199"), expectedOutput);
        });

        it("if input year is a bool an error is expected", () =>{
            //assign
            let expectedOutput = `Invalid Year!`;

            //act && assert
            assert.throw(() => chooseYourCar.choosingType("sedan","blue",true), expectedOutput);
        });

        it("if input year is null an error is expected", () =>{
            //assign
            let expectedOutput = `Invalid Year!`;

            //act && assert
            assert.throw(() => chooseYourCar.choosingType("sedan","blue",null), expectedOutput);
        });
        ...
        it("if type is different than Sedan an error is expected - input number", () =>{
            //assign
            let expectedOutput = `This type of car is not what you are looking for.`;

            //act && assert
            assert.throw(() => chooseYourCar.choosingType(13,"blue",1900), expectedOutput);
        });

        it("if type is different than Sedan an error is expected - null", () =>{
            //assign
            let expectedOutput = `This type of car is not what you are looking for.`;

            //act && assert
            assert.throw(() => chooseYourCar.choosingType(null,"blue",1900), expectedOutput);
        });


        it("if type is different than Sedan an error is expected  - undefined", () =>{
            //assign
            let expectedOutput = `This type of car is not what you are looking for.`;

            //act && assert
            assert.throw(() => chooseYourCar.choosingType(undefined,"blue",1900), expectedOutput);
        });

        it("if type is different than Sedan an error is expected - bool", () =>{
            //assign
            let expectedOutput = `This type of car is not what you are looking for.`;

            //act && assert
            assert.throw(() => chooseYourCar.choosingType(true,"blue",1900), expectedOutput);
        });
